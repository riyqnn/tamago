...
import { useCreatePvpChallenge } from "@/hooks/useCreatePvpChallenge";
...
export default function PetComponent({ pet }: PetDashboardProps) {
  ...
  const { mutate: createChallenge, data: challengeData, isPending: isCreating } = useCreatePvpChallenge();
